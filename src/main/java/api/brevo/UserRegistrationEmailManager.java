...
/**
    ...
    * @since v1.0
*/
public class UserRegistrationEmailManager {
    /**
    ...
    */
    ...
    /**
        * Cria e envia o e-mail de confirmação de cadastro.
        * 
        ...
        * @author              isaquesv
    */
    public static JSONObject sendRegistrationConfirmationEmail(String name, String email, String token) {
        ...
        String messageHTMLBody =  
            "<div style='max-width: 600px; margin: 20px auto; background: #FDFDFD; border: 1px solid #E0E0E0; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); font-family: Arial, sans-serif;'>" +
                ...
                "<div style='padding: 25px; color: #333333;'>" +
                    ...
                    "<p style='margin: 0 0 15px; line-height: 1.8;'><a href='localhost:8080/user-auth-platform/verify-user-registration-token.jsp?token=" + token + "'>Confirmar Cadastro</a></p>" +
        ...
        try {
            ...
            if (response.statusCode() == 201) {
                ...
                emailSendResultJSON.put("message", "Enviamos um e-mail de confirmação para: <b>" + email + "</b>. Para concluir o seu cadastro, acesse o e-mail e clique no link de confirmação.");
            } else {
